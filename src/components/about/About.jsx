      ...
      <motion.section className="grid grid-cols-1 md:grid-cols-3 px-4 md:px-10 gap-2">
        ...
        >
          ...
          <p>
            ...
            <span className="text-fuchsia-500 font-semibold">Benjamin</span>, et
          ...
          <p>
            Mon parcours est guidé par cette conviction : l'apprentissage est un
            voyage continu où chaque étape permet de se surpasser.
          </p>
        </motion.div>
      </motion.section>
    </Element>
